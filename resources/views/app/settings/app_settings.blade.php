...
<div class="card bg-info"> 
  <div class="justify-content-between align-items-center mx-50 pt-2 pb-2"> 
    <h1 class="text-center text-white">اعدادات برنامج  {{$record->name}}   </h1>
  </div>
</div> 
