          ...
          <div class="wrap-table100">
            ...
            <div class="table100 ver5 m-b-110">
              <table data-vertable="ver5">
                <thead>  
                  <tr class="row100 head">
                    <th class="column100 column1" data-column="column1"> الرسالة  </th> 
                  </tr>
                </thead>
                <tbody>   
                  <tr  class="row100"> 
                    <td class="column100 column1" data-column="column1"> {{$settings->message}}</td> 
                  </tr>   
                </tbody>
              </table>
              ...
              <table data-vertable="ver5">
                <thead>  
                  <tr class="row100 head">
                    <th class="column100 column1" data-column="column1">الرؤية    </th> 
                  </tr>
                </thead>
                <tbody>   
                  <tr  class="row100"> 
                    <td class="column100 column1" data-column="column1"> {{$settings->vision}}</td> 
                  </tr>   
                </tbody>
              </table>
              ...
              <table data-vertable="ver5">
                <thead>  
                  <tr class="row100 head">
                    <th class="column100 column1" data-column="column1">الاهداف    </th> 
                  </tr>
                </thead>
                <tbody>   
                  <tr  class="row100"> 
                    <td class="column100 column1" data-column="column1"> {{$settings->goals}}</td> 
                  </tr>   
                </tbody>
              </table> 
